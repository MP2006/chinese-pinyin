        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {filtered.map((card) => {
            ...
            return (
              ...
              >
                <div
                  className="relative h-52 w-full transition-transform duration-400"
                  style={{
                ...
                >
                  {/* Front */}
                  <div
                    className="absolute inset-0 flex flex-col items-center justify-center rounded-xl border border-border bg-surface-card p-5"
